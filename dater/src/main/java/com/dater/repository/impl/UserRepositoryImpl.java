...
public class UserRepositoryImpl extends AbstractRepository implements CustomUserRepository {
	...
	@Override
	public List<String> findDateIdsForUser(UserEntity user, SkippingPageable pageable) {	
	...
	@Override
	public List<String> findLikedByIdsForUser(UserEntity user, SkippingPageable pageable) {
	...
	@Override
	public List<String> findFavoriteIdsForUser(UserEntity user, SkippingPageable pageable) {
